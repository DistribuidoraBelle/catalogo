---
name: market
description: AI Marketing Suite orchestrator. Routes /market commands to run website audits, generate copy, emails, social calendars, ads, funnels, competitor analysis, launches, proposals, SEO and brand reports from the command line. Use for any /market <command> request or comprehensive marketing analysis of a website.
license: MIT (zubair-trabzada/ai-marketing-claude)
---
